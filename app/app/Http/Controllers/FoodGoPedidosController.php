...
class FoodGoPedidosController extends Controller
{
    ...
    public function index()
    {
       ...
       $bigTotal = 0;
        ...
        return view('goFood.index', compact('anio','ordenes','totales','detalles','bigTotal'));
    }
    ...
    public function edit($id)
    {
        ...
        $pedido->estado = 1;
        $pedido->save();
        return Redirect::to('/pedidosLlevar');
    }
