        ...
        <div class="panel-body">
           <!-- Form wizard with Validation -->
					            ...
					            <div id="demo-bv-wz">
					                ...
					                <!--Form-->
                                    {!! Form::open(['route'=>['recetaMenu.update', $menu->id_menu], 'id'=>'demo-bv-wz-form','class'=>'panel-body form-horizontal form-padding', 'enctype' => 'multipart/form-data','method'=>'PUT']) !!}
					                    <div class="panel-body">
					                        <div class="tab-content">
					                            ...
					                            <div id="demo-bv-tab1" class="tab-pane">
					                                    ...
					                                    <div class="col-lg-7">
															<select name="tipoPlatillo" id="tipoPlatillo" class="form-control" required>
																@foreach ($type_foods as $item)
                                                                    @if($item->id_type_foods == $menu->type_foods)
                                                                        <option value="{{$item->id_type_foods}}" selected>{{$item->descripcion}}</option>
                                                                    @else
					                                ...
					                                <div class="form-group">
					                                    ...
					                                    <div class="col-lg-7">
                                                            {!! Form::text('platillo', $menu->descripcion, ['class'=>'form-control', 'id'=>'platillo', 'placeholder'=>'Ingrese el nombre del platillo', 'required'=>'']) !!}
					                                    </div>
													</div>
													<div class="form-group">
					                                    <label class="col-lg-3 control-label">Descripción corta de platillo</label>
					                                    <div class="col-lg-7">
                                                            {!! Form::text('resumen', $menu->resumen, ['class'=>'form-control', 'id'=>'resumen', 'placeholder'=>'Ingrese la descripción corta del platillo', 'required'=>'']) !!}
					                                    </div>
													</div>
													<div class="form-group">
					                            ...
					                            <div id="demo-bv-tab2" class="tab-pane fade">
					                                <div class="form-group">
					                                    ...
					                                    <div class="col-lg-7">
                                                            {!! Form::textarea('receta', $receta->proceso, ['class'=>'form-control', 'id'=>'receta', 'placeholder'=>'Ingrese la receta del platillo', 'required'=>'']) !!}
					                                    </div>
					                                </div>
					                                <div class="form-group">
					                                    <label class="col-lg-3 control-label">Tiempo de preparación</label>
					                                    <div class="col-lg-7">
                                                            {!! Form::text('tiempo', $receta->tiempo, ['class'=>'form-control', 'id'=>'tiempo', 'placeholder'=>'Ingrese tiempo de preparacion', 'required'=>'']) !!}
					                                    </div>
													</div>
													<div class="form-group">
					                                    <label class="col-lg-3 control-label">Ingrese los ingredientes</label>
					                                    <div class="col-lg-7">
															{!! Form::text('ingredientes', $receta->ingredientes, ['class'=>'form-control', 'id'=>'ingredientes', 'placeholder'=>'Ingrese los ingredientes', 'data-role'=>'tagsinput','required'=>'']) !!}
					                                    </div>
					                                </div>
					                            </div>
					                                    ...
					                                    <div class="col-lg-7">
															<select class="js-example-basic-multiple" style="width:100%;" name="states[]" multiple="multiple" data-placeholder="--- Seleccione las franquicias ---" required>
																@foreach ($type_franchise as $item)
                                                                        @if( in_array( $item->id_type_franchise , $franquiciaText)  )
                                                                            <option value="{{$item->id_type_franchise}}" selected>{{$item->descripcion_franquicia}}</option>
                                                                        @else 
					                            ...
					                            <div id="demo-bv-tab4" class="tab-pane  mar-btm text-center">
					                                <h4>Finalizar</h4>
					                                <p class="text-muted">Esta a punto de editar un platillo del menú de una o varias franquicias al finalizar esta sera visible para los restaurantes. </p>
					                            </div>
					                        </div>
					                    </div>
