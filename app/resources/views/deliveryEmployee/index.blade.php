            ...
            <table id="dtable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        ...
                        <th class="min-tablet">Pedido</th> 
                        <th class="min-tablet">Contactos</th>   
                    </tr>
                </thead>
                <tbody>
                    @foreach ($ordenes as $item)
                        <tr>
                            <td>
                                <a href="{{route('pedidosDelivery.edit',[$item->id])}}" class="btn btn-md btn-mint btn-icon add-tooltip" data-toggle="tooltip" data-container="body" data-placement="top" data-original-title="Confirmar Entrega"><i class="ion-checkmark-round icon-lg"></i></a>
                            </td>
                            <td>{{$item->id}}</td>
                            <td>{{$item->date}}</td>
