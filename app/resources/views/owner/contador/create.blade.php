        ...
        <div class="panel-body">
           <!-- Form wizard with Validation -->
					            ...
					            <div id="demo-bv-wz">
					                ...
					                <!--Form-->
                                    {!! Form::open(['route'=>['contador.store'], 'id'=>'demo-bv-wz-form','class'=>'panel-body form-horizontal form-padding','method'=>'POST']) !!}
					                    <div class="panel-body">
					                        <div class="tab-content">
					                            ...
					                            <div id="demo-bv-tab4" class="tab-pane  mar-btm text-center">
					                                <h4>Finalizar</h4>
					                                <p class="text-muted">Esta a punto de crear una cuenta de usuario para contador al finalizar. </p>
					                            </div>
					                        </div>
					                    </div>
