...
<div id="page-head">
    ...
    <div class="pad-all text-center">
        <h3>Crear Propietario de Franquicia</h3>
    </div>
</div>
        ...
        <div class="panel-body">
           <!-- Form wizard with Validation -->
					            ...
					            <div id="demo-bv-wz">
					                ...
					                <!--Form-->
                                    {!! Form::open(['route'=>['owner.store'], 'id'=>'demo-bv-wz-form','class'=>'panel-body form-horizontal form-padding','method'=>'POST']) !!}
					                    <div class="panel-body">
					                        <div class="tab-content">
					                            ...
					                            <div id="demo-bv-tab3" class="tab-pane">
					                                <div class="form-group">
														<label class="col-lg-3 control-label">Tipo de franquicia</label>
														<div class="col-lg-7">
													...
													<div class="form-group">
														<label class="col-lg-3 control-label">Tipo de precio</label>
														<div class="col-lg-7">
															<select name="idTypePrice" id="idTypePrice" class="form-control" required>
					                            ...
					                            <div id="demo-bv-tab4" class="tab-pane  mar-btm text-center">
					                                <h4>Finalizar</h4>
					                                <p class="text-muted">Esta a punto de crear una cuenta de usuario para el propietario de una franquicia al finalizar se enviará un correo de forma automática al correo de la cuenta creada. </p>
					                            </div>
					                        </div>
					                    </div>
