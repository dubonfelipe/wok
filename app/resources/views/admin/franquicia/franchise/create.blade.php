...
<div id="page-content">
    <div class="panel">
        <div class="panel-body">
            ...
            {!! Form::open(['route'=>['franchise.store'],'class'=>'panel-body form-horizontal form-padding','method'=>'POST']) !!}
                {!!Form::hidden('idowner',$id_owner)!!}
                ...
                <div class="form-group">
                    <label class="col-md-2 control-label" for="demo-text-input">Tipo de Precio</label>
                    <div class="col-md-9">
