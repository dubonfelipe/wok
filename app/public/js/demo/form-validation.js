...
$(document).on('nifty.ready', function() {
    ...
    $('#demo-bvd-notempty').bootstrapValidator({
        ...
        acceptTerms: {
            validators: {
                notEmpty: {
                    message: 'Usted ha aceptado los terminos y políticas'
                }
            }
        },
        password: {
            validators: {
                notEmpty: {
                    message: 'La constraseña es requerida y no puede ser vacío'
                },
                identical: {
                    field: 'confirmPassword',
                    message: 'La contraseña y la confirmación no concuerdan'
                }
            }
        },
        confirmPassword: {
            validators: {
                notEmpty: {
                    message: 'La confirmación de contraseña es requerida y no puede ser vacío'
                },
                identical: {
                    field: 'password',
                    message: 'La contraseña y la confirmación no concuerdan'
        ...
        integer: {
            validators: {
                notEmpty: {
                    message: 'El número es requerido y no puede ser vacío'
                },
                integer: {
    ...
    $('#telefono_franquicia').mask('9999-9999');
