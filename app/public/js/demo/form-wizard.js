...
$(document).on('nifty.ready', function() {
    ...
    $('#demo-bv-wz-form').bootstrapValidator({
        ...
        fields: {
        idTypePrice:{
            message: 'Debe de seleccionar un tipo de precio',
            validators: {
                notEmpty: {
                    message: 'Debe de seleccionar un tipo de precio válido.'
                }
            }
        },
        ifFranchise:{
            message: 'Debe de seleccionar un tipo de franquicia',
            validators: {
                notEmpty: {
                    message: 'Debe de seleccionar un tipo de francia válida.'
                }
            }
        },
        username: {
        ...
        email: {
            validators: {
                notEmpty: {
                    message: 'La direccón de email es requerida y no puede estar vacío'
                },
                emailAddress: {
        ...
        fname: {
            validators: {
                notEmpty: {
                    message: 'El primer apellido es requerido y no puede ser vacío'
                },
                regexp: {
                    regexp: /^[A-Z\s]+$/i,
                    message: 'El primer apellido solo puede consistir de carácteres alfabeticos y espacios'
                }
            }
        },
        lname: {
            validators: {
                notEmpty: {
                    message: 'El primer nombre es requerido y no puede ser vacío'
                },
                regexp: {
                    regexp: /^[A-Z\s]+$/i,
                    message: 'El primer nombre solo puede consistir de carácteres alfabeticos y espacios'
                }
            }
        },
        firstName: {
