...
class SecureBlackbox_CAdESVerifier {
  ...
  public function __construct() {
    ...
    secureblackbox_cadesverifier_register_callback($this->handle, 5, array($this, 'fireSignatureFound'));
    secureblackbox_cadesverifier_register_callback($this->handle, 6, array($this, 'fireSignatureValidated'));
    secureblackbox_cadesverifier_register_callback($this->handle, 7, array($this, 'fireTimestampFound'));
    secureblackbox_cadesverifier_register_callback($this->handle, 8, array($this, 'fireTimestampValidated'));
  }
...
public function VERSION() {
  ...
  */
  public function setIgnoreChainValidationErrors($value) {
    $ret = secureblackbox_cadesverifier_set($this->handle, 80, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_cadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getKnownCertBytes($knowncertindex) {
    return secureblackbox_cadesverifier_get($this->handle, 83 , $knowncertindex);
  }
  ...
  */
  public function getKnownCertHandle($knowncertindex) {
    return secureblackbox_cadesverifier_get($this->handle, 84 , $knowncertindex);
  }
 /**
  * Allows to get or set a 'handle', a unique identifier of the underlying property object.
  *
  ...
  */
  public function setKnownCertHandle($knowncertindex, $value) {
    $ret = secureblackbox_cadesverifier_set($this->handle, 84, $value , $knowncertindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_cadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getKnownCRLCount() {
    return secureblackbox_cadesverifier_get($this->handle, 85 );
  }
 /**
  * The number of records in the KnownCRL arrays.
  *
  ...
  */
  public function setKnownCRLCount($value) {
    $ret = secureblackbox_cadesverifier_set($this->handle, 85, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_cadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getKnownCRLBytes($knowncrlindex) {
    return secureblackbox_cadesverifier_get($this->handle, 86 , $knowncrlindex);
  }
  ...
  */
  public function getKnownCRLHandle($knowncrlindex) {
    return secureblackbox_cadesverifier_get($this->handle, 87 , $knowncrlindex);
  }
 /**
  * Allows to get or set a 'handle', a unique identifier of the underlying property object.
  *
  ...
  */
  public function setKnownCRLHandle($knowncrlindex, $value) {
    $ret = secureblackbox_cadesverifier_set($this->handle, 87, $value , $knowncrlindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_cadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getKnownOCSPCount() {
    return secureblackbox_cadesverifier_get($this->handle, 88 );
  }
 /**
  * The number of records in the KnownOCSP arrays.
  *
  ...
  */
  public function setKnownOCSPCount($value) {
    $ret = secureblackbox_cadesverifier_set($this->handle, 88, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_cadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getKnownOCSPBytes($knownocspindex) {
    return secureblackbox_cadesverifier_get($this->handle, 89 , $knownocspindex);
  }
  ...
  */
  public function getKnownOCSPHandle($knownocspindex) {
    return secureblackbox_cadesverifier_get($this->handle, 90 , $knownocspindex);
  }
 /**
  * Allows to get or set a 'handle', a unique identifier of the underlying property object.
  *
  ...
  */
  public function setKnownOCSPHandle($knownocspindex, $value) {
    $ret = secureblackbox_cadesverifier_set($this->handle, 90, $value , $knownocspindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_cadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getLastArchivalTime() {
    return secureblackbox_cadesverifier_get($this->handle, 91 );
  }
  ...
  */
  public function getLevel() {
    return secureblackbox_cadesverifier_get($this->handle, 92 );
  }
  ...
  */
  public function getOCSPBytes($ocspindex) {
    return secureblackbox_cadesverifier_get($this->handle, 95 , $ocspindex);
  }
  ...
  */
  public function getOCSPHandle($ocspindex) {
    return secureblackbox_cadesverifier_get($this->handle, 96 , $ocspindex);
  }
  ...
  */
  public function getOfflineMode() {
    return secureblackbox_cadesverifier_get($this->handle, 101 );
  }
 /**
  * Switches the class to the offline mode.
  *
  ...
  */
  public function setOfflineMode($value) {
    $ret = secureblackbox_cadesverifier_set($this->handle, 101, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_cadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getOutputFile() {
    return secureblackbox_cadesverifier_get($this->handle, 102 );
  }
 /**
  * A path to the file to write the extracted data to.
  *
  ...
  */
  public function setOutputFile($value) {
    $ret = secureblackbox_cadesverifier_set($this->handle, 102, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_cadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function setProxyAddress($value) {
    $ret = secureblackbox_cadesverifier_set($this->handle, 106, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_cadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function setProxyAuthentication($value) {
    $ret = secureblackbox_cadesverifier_set($this->handle, 107, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_cadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function setProxyPassword($value) {
    $ret = secureblackbox_cadesverifier_set($this->handle, 108, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_cadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getSignedAttributeOID($signedattributeindex) {
    return secureblackbox_cadesverifier_get($this->handle, 122 , $signedattributeindex);
  }
  ...
  */
  public function getSignedAttributeValue($signedattributeindex) {
    return secureblackbox_cadesverifier_get($this->handle, 123 , $signedattributeindex);
  }
  ...
  */
  public function getSigningCertCAKeyID() {
    return secureblackbox_cadesverifier_get($this->handle, 126 );
  }
  ...
  */
  public function getSigningCertCRLDistributionPoints() {
    return secureblackbox_cadesverifier_get($this->handle, 127 );
  }
  ...
  */
  public function setSocketDNSMode($value) {
    $ret = secureblackbox_cadesverifier_set($this->handle, 155, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_cadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function setSocketDNSPort($value) {
    $ret = secureblackbox_cadesverifier_set($this->handle, 156, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_cadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function setSocketDNSQueryTimeout($value) {
    $ret = secureblackbox_cadesverifier_set($this->handle, 157, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_cadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function setSocketDNSServers($value) {
    $ret = secureblackbox_cadesverifier_set($this->handle, 158, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_cadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function setTLSAutoValidateCertificates($value) {
    $ret = secureblackbox_cadesverifier_set($this->handle, 178, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_cadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function setTLSBaseConfiguration($value) {
    $ret = secureblackbox_cadesverifier_set($this->handle, 179, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_cadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function setTLSCiphersuites($value) {
    $ret = secureblackbox_cadesverifier_set($this->handle, 180, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_cadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function setTLSECCurves($value) {
    $ret = secureblackbox_cadesverifier_set($this->handle, 181, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_cadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getTLSPreSharedIdentity() {
    return secureblackbox_cadesverifier_get($this->handle, 183 );
  }
 /**
  * Defines the identity used when the PSK (Pre-Shared Key) key-exchange mechanism is negotiated.
  *
  ...
  */
  public function setTLSPreSharedIdentity($value) {
    $ret = secureblackbox_cadesverifier_set($this->handle, 183, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_cadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getTLSPreSharedKey() {
    return secureblackbox_cadesverifier_get($this->handle, 184 );
  }
 /**
  * Contains the pre-shared for the PSK (Pre-Shared Key) key-exchange mechanism, encoded with base16.
  *
  ...
  */
  public function setTLSPreSharedKey($value) {
    $ret = secureblackbox_cadesverifier_set($this->handle, 184, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_cadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function setTLSPreSharedKeyCiphersuite($value) {
    $ret = secureblackbox_cadesverifier_set($this->handle, 185, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_cadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getTLSRenegotiationAttackPreventionMode() {
    return secureblackbox_cadesverifier_get($this->handle, 186 );
  }
 /**
  * Selects renegotiation attack prevention mechanism.
  *
  ...
  */
  public function setTLSRenegotiationAttackPreventionMode($value) {
    $ret = secureblackbox_cadesverifier_set($this->handle, 186, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_cadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getTLSRevocationCheck() {
    return secureblackbox_cadesverifier_get($this->handle, 187 );
  }
 /**
  * Specifies the kind(s) of revocation check to perform.
  *
  ...
  */
  public function setTLSRevocationCheck($value) {
    $ret = secureblackbox_cadesverifier_set($this->handle, 187, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_cadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getTrustedCertBytes($trustedcertindex) {
    return secureblackbox_cadesverifier_get($this->handle, 194 , $trustedcertindex);
  }
  ...
  */
  public function getTrustedCertHandle($trustedcertindex) {
    return secureblackbox_cadesverifier_get($this->handle, 195 , $trustedcertindex);
  }
 /**
  * Allows to get or set a 'handle', a unique identifier of the underlying property object.
  *
  ...
  */
  public function setTrustedCertHandle($trustedcertindex, $value) {
    $ret = secureblackbox_cadesverifier_set($this->handle, 195, $value , $trustedcertindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_cadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getTSACertHashAlgorithm() {
    return secureblackbox_cadesverifier_get($this->handle, 204 );
  }
  ...
  */
  public function getTSACertIssuer() {
    return secureblackbox_cadesverifier_get($this->handle, 205 );
  }
  ...
  */
  public function getUnsignedAttributeOID($unsignedattributeindex) {
    return secureblackbox_cadesverifier_get($this->handle, 224 , $unsignedattributeindex);
  }
  ...
  */
  public function getUnsignedAttributeValue($unsignedattributeindex) {
    return secureblackbox_cadesverifier_get($this->handle, 225 , $unsignedattributeindex);
  }
  ...
  */
  public function setValidationMoment($value) {
    $ret = secureblackbox_cadesverifier_set($this->handle, 228, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_cadesverifier_get_last_error($this->handle));
    }
    return $ret;
