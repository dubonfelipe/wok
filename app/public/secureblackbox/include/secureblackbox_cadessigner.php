...
public function VERSION() {
  ...
  */
  public function getKnownCertBytes($knowncertindex) {
    return secureblackbox_cadessigner_get($this->handle, 21 , $knowncertindex);
  }
  ...
  */
  public function getKnownCertHandle($knowncertindex) {
    return secureblackbox_cadessigner_get($this->handle, 22 , $knowncertindex);
  }
 /**
  * Allows to get or set a 'handle', a unique identifier of the underlying property object.
  *
  ...
  */
  public function setKnownCertHandle($knowncertindex, $value) {
    $ret = secureblackbox_cadessigner_set($this->handle, 22, $value , $knowncertindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_cadessigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getKnownCRLCount() {
    return secureblackbox_cadessigner_get($this->handle, 23 );
  }
 /**
  * The number of records in the KnownCRL arrays.
  *
  ...
  */
  public function setKnownCRLCount($value) {
    $ret = secureblackbox_cadessigner_set($this->handle, 23, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_cadessigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getKnownCRLBytes($knowncrlindex) {
    return secureblackbox_cadessigner_get($this->handle, 24 , $knowncrlindex);
  }
  ...
  */
  public function getKnownCRLHandle($knowncrlindex) {
    return secureblackbox_cadessigner_get($this->handle, 25 , $knowncrlindex);
  }
 /**
  * Allows to get or set a 'handle', a unique identifier of the underlying property object.
  *
  ...
  */
  public function setKnownCRLHandle($knowncrlindex, $value) {
    $ret = secureblackbox_cadessigner_set($this->handle, 25, $value , $knowncrlindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_cadessigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getKnownOCSPCount() {
    return secureblackbox_cadessigner_get($this->handle, 26 );
  }
 /**
  * The number of records in the KnownOCSP arrays.
  *
  ...
  */
  public function setKnownOCSPCount($value) {
    $ret = secureblackbox_cadessigner_set($this->handle, 26, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_cadessigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getKnownOCSPBytes($knownocspindex) {
    return secureblackbox_cadessigner_get($this->handle, 27 , $knownocspindex);
  }
  ...
  */
  public function getKnownOCSPHandle($knownocspindex) {
    return secureblackbox_cadessigner_get($this->handle, 28 , $knownocspindex);
  }
 /**
  * Allows to get or set a 'handle', a unique identifier of the underlying property object.
  *
  ...
  */
  public function setKnownOCSPHandle($knownocspindex, $value) {
    $ret = secureblackbox_cadessigner_set($this->handle, 28, $value , $knownocspindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_cadessigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getOfflineMode() {
    return secureblackbox_cadessigner_get($this->handle, 29 );
  }
 /**
  * Switches the class to the offline mode.
  *
  ...
  */
  public function setOfflineMode($value) {
    $ret = secureblackbox_cadessigner_set($this->handle, 29, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_cadessigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getOutputFile() {
    return secureblackbox_cadessigner_get($this->handle, 30 );
  }
 /**
  * A file where the signed data is to be saved.
  *
  ...
  */
  public function setOutputFile($value) {
    $ret = secureblackbox_cadessigner_set($this->handle, 30, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_cadessigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function setPolicyHashAlgorithm($value) {
    $ret = secureblackbox_cadessigner_set($this->handle, 32, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_cadessigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getSignedAttributeOID($signedattributeindex) {
    return secureblackbox_cadessigner_get($this->handle, 49 , $signedattributeindex);
  }
 /**
  * The object identifier of the attribute.
  *
  ...
  */
  public function setSignedAttributeOID($signedattributeindex, $value) {
    $ret = secureblackbox_cadessigner_set($this->handle, 49, $value , $signedattributeindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_cadessigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getSignedAttributeValue($signedattributeindex) {
    return secureblackbox_cadessigner_get($this->handle, 50 , $signedattributeindex);
  }
 /**
  * The value of the attribute.
  *
  ...
  */
  public function setSignedAttributeValue($signedattributeindex, $value) {
    $ret = secureblackbox_cadessigner_set($this->handle, 50, $value , $signedattributeindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_cadessigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getSigningChainCount() {
    return secureblackbox_cadessigner_get($this->handle, 53 );
  }
 /**
  * The number of records in the SigningChain arrays.
  *
  ...
  */
  public function setSigningChainCount($value) {
    $ret = secureblackbox_cadessigner_set($this->handle, 53, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_cadessigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getSigningChainBytes($signingchainindex) {
    return secureblackbox_cadessigner_get($this->handle, 54 , $signingchainindex);
  }
  ...
  */
  public function getSigningChainHandle($signingchainindex) {
    return secureblackbox_cadessigner_get($this->handle, 55 , $signingchainindex);
  }
 /**
  * Allows to get or set a 'handle', a unique identifier of the underlying property object.
  *
  ...
  */
  public function setSigningChainHandle($signingchainindex, $value) {
    $ret = secureblackbox_cadessigner_set($this->handle, 55, $value , $signingchainindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_cadessigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getSocketDNSQueryTimeout() {
    return secureblackbox_cadessigner_get($this->handle, 58 );
  }
 /**
  * The timeout (in milliseconds) for each DNS query.
  *
  ...
  */
  public function setSocketDNSQueryTimeout($value) {
    $ret = secureblackbox_cadessigner_set($this->handle, 58, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_cadessigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getSocketDNSServers() {
    return secureblackbox_cadessigner_get($this->handle, 59 );
  }
 /**
  * The addresses of DNS servers to use for address resolution, separated by commas or semicolons.
  *
  ...
  */
  public function setSocketDNSServers($value) {
    $ret = secureblackbox_cadessigner_set($this->handle, 59, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_cadessigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getTLSPreSharedIdentity() {
    return secureblackbox_cadessigner_get($this->handle, 73 );
  }
 /**
  * Defines the identity used when the PSK (Pre-Shared Key) key-exchange mechanism is negotiated.
  *
  ...
  */
  public function setTLSPreSharedIdentity($value) {
    $ret = secureblackbox_cadessigner_set($this->handle, 73, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_cadessigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getTLSPreSharedKey() {
    return secureblackbox_cadessigner_get($this->handle, 74 );
  }
 /**
  * Contains the pre-shared for the PSK (Pre-Shared Key) key-exchange mechanism, encoded with base16.
  *
  ...
  */
  public function setTLSPreSharedKey($value) {
    $ret = secureblackbox_cadessigner_set($this->handle, 74, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_cadessigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function setTLSPreSharedKeyCiphersuite($value) {
    $ret = secureblackbox_cadessigner_set($this->handle, 75, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_cadessigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getTLSRenegotiationAttackPreventionMode() {
    return secureblackbox_cadessigner_get($this->handle, 76 );
  }
 /**
  * Selects renegotiation attack prevention mechanism.
  *
  ...
  */
  public function setTLSRenegotiationAttackPreventionMode($value) {
    $ret = secureblackbox_cadessigner_set($this->handle, 76, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_cadessigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getTLSRevocationCheck() {
    return secureblackbox_cadessigner_get($this->handle, 77 );
  }
 /**
  * Specifies the kind(s) of revocation check to perform.
  *
  ...
  */
  public function setTLSRevocationCheck($value) {
    $ret = secureblackbox_cadessigner_set($this->handle, 77, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_cadessigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getTrustedCertBytes($trustedcertindex) {
    return secureblackbox_cadessigner_get($this->handle, 84 , $trustedcertindex);
  }
  ...
  */
  public function getTrustedCertHandle($trustedcertindex) {
    return secureblackbox_cadessigner_get($this->handle, 85 , $trustedcertindex);
  }
 /**
  * Allows to get or set a 'handle', a unique identifier of the underlying property object.
  *
  ...
  */
  public function setTrustedCertHandle($trustedcertindex, $value) {
    $ret = secureblackbox_cadessigner_set($this->handle, 85, $value , $trustedcertindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_cadessigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getUnsignedAttributeOID($unsignedattributeindex) {
    return secureblackbox_cadessigner_get($this->handle, 87 , $unsignedattributeindex);
  }
 /**
  * The object identifier of the attribute.
  *
  ...
  */
  public function setUnsignedAttributeOID($unsignedattributeindex, $value) {
    $ret = secureblackbox_cadessigner_set($this->handle, 87, $value , $unsignedattributeindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_cadessigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getUnsignedAttributeValue($unsignedattributeindex) {
    return secureblackbox_cadessigner_get($this->handle, 88 , $unsignedattributeindex);
  }
 /**
  * The value of the attribute.
  *
  ...
  */
  public function setUnsignedAttributeValue($unsignedattributeindex, $value) {
    $ret = secureblackbox_cadessigner_set($this->handle, 88, $value , $unsignedattributeindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_cadessigner_get_last_error($this->handle));
    }
    return $ret;
