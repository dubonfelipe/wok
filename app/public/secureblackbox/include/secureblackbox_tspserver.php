...
class SecureBlackbox_TSPServer {
  ...
  public function __construct() {
    ...
    secureblackbox_tspserver_register_callback($this->handle, 8, array($this, 'fireTimestampRequest'));
    secureblackbox_tspserver_register_callback($this->handle, 9, array($this, 'fireTLSEstablished'));
    secureblackbox_tspserver_register_callback($this->handle, 10, array($this, 'fireTLSPSK'));
    secureblackbox_tspserver_register_callback($this->handle, 11, array($this, 'fireTLSShutdown'));
  }
