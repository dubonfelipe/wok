...
class SecureBlackbox_AuthenticodeSigner {
  ...
  public function __construct() {
    ...
    secureblackbox_authenticodesigner_register_callback($this->handle, 3, array($this, 'fireStart'));
  }
...
public function VERSION() {
  ...
  */
  public function getKnownCertBytes($knowncertindex) {
    return secureblackbox_authenticodesigner_get($this->handle, 18 , $knowncertindex);
  }
  ...
  */
  public function setKnownCertHandle($knowncertindex, $value) {
    $ret = secureblackbox_authenticodesigner_set($this->handle, 19, $value , $knowncertindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_authenticodesigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getKnownCRLCount() {
    return secureblackbox_authenticodesigner_get($this->handle, 20 );
  }
 /**
  * The number of records in the KnownCRL arrays.
  *
  ...
  */
  public function setKnownCRLCount($value) {
    $ret = secureblackbox_authenticodesigner_set($this->handle, 20, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_authenticodesigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getKnownCRLBytes($knowncrlindex) {
    return secureblackbox_authenticodesigner_get($this->handle, 21 , $knowncrlindex);
  }
  ...
  */
  public function setKnownCRLHandle($knowncrlindex, $value) {
    $ret = secureblackbox_authenticodesigner_set($this->handle, 22, $value , $knowncrlindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_authenticodesigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getKnownOCSPCount() {
    return secureblackbox_authenticodesigner_get($this->handle, 23 );
  }
 /**
  * The number of records in the KnownOCSP arrays.
  *
  ...
  */
  public function setKnownOCSPCount($value) {
    $ret = secureblackbox_authenticodesigner_set($this->handle, 23, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_authenticodesigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getKnownOCSPBytes($knownocspindex) {
    return secureblackbox_authenticodesigner_get($this->handle, 24 , $knownocspindex);
  }
  ...
  */
  public function setKnownOCSPHandle($knownocspindex, $value) {
    $ret = secureblackbox_authenticodesigner_set($this->handle, 25, $value , $knownocspindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_authenticodesigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getOfflineMode() {
    return secureblackbox_authenticodesigner_get($this->handle, 26 );
  }
 /**
  * Switches the class to the offline mode.
  *
  ...
  */
  public function setOfflineMode($value) {
    $ret = secureblackbox_authenticodesigner_set($this->handle, 26, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_authenticodesigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function setProxyAddress($value) {
    $ret = secureblackbox_authenticodesigner_set($this->handle, 28, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_authenticodesigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getSigningChainBytes($signingchainindex) {
    return secureblackbox_authenticodesigner_get($this->handle, 46 , $signingchainindex);
  }
  ...
  */
  public function getSigningChainHandle($signingchainindex) {
    return secureblackbox_authenticodesigner_get($this->handle, 47 , $signingchainindex);
  }
 /**
  * Allows to get or set a 'handle', a unique identifier of the underlying property object.
  *
  ...
  */
  public function setSigningChainHandle($signingchainindex, $value) {
    $ret = secureblackbox_authenticodesigner_set($this->handle, 47, $value , $signingchainindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_authenticodesigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getSocketDNSPort() {
    return secureblackbox_authenticodesigner_get($this->handle, 49 );
  }
 /**
  * Specifies the port number to be used for sending queries to the DNS server.
  *
  ...
  */
  public function setSocketDNSPort($value) {
    $ret = secureblackbox_authenticodesigner_set($this->handle, 49, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_authenticodesigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getSocketDNSQueryTimeout() {
    return secureblackbox_authenticodesigner_get($this->handle, 50 );
  }
 /**
  * The timeout (in milliseconds) for each DNS query.
  *
  ...
  */
  public function setSocketDNSQueryTimeout($value) {
    $ret = secureblackbox_authenticodesigner_set($this->handle, 50, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_authenticodesigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getTLSForceResumeIfDestinationChanges() {
    return secureblackbox_authenticodesigner_get($this->handle, 66 );
  }
 /**
  * Whether to force TLS session resumption when the destination address changes.
  *
  ...
  */
  public function setTLSForceResumeIfDestinationChanges($value) {
    $ret = secureblackbox_authenticodesigner_set($this->handle, 66, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_authenticodesigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getTLSPreSharedIdentity() {
    return secureblackbox_authenticodesigner_get($this->handle, 67 );
  }
 /**
  * Defines the identity used when the PSK (Pre-Shared Key) key-exchange mechanism is negotiated.
  *
  ...
  */
  public function setTLSPreSharedIdentity($value) {
    $ret = secureblackbox_authenticodesigner_set($this->handle, 67, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_authenticodesigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function setTLSPreSharedKey($value) {
    $ret = secureblackbox_authenticodesigner_set($this->handle, 68, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_authenticodesigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getTLSPreSharedKeyCiphersuite() {
    return secureblackbox_authenticodesigner_get($this->handle, 69 );
  }
 /**
  * Defines the ciphersuite used for PSK (Pre-Shared Key) negotiation.
  *
  ...
  */
  public function setTLSPreSharedKeyCiphersuite($value) {
    $ret = secureblackbox_authenticodesigner_set($this->handle, 69, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_authenticodesigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getTLSRenegotiationAttackPreventionMode() {
    return secureblackbox_authenticodesigner_get($this->handle, 70 );
  }
 /**
  * Selects renegotiation attack prevention mechanism.
  *
  ...
  */
  public function setTLSRenegotiationAttackPreventionMode($value) {
    $ret = secureblackbox_authenticodesigner_set($this->handle, 70, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_authenticodesigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getTrustedCertBytes($trustedcertindex) {
    return secureblackbox_authenticodesigner_get($this->handle, 78 , $trustedcertindex);
  }
  ...
  */
  public function getTrustedCertHandle($trustedcertindex) {
    return secureblackbox_authenticodesigner_get($this->handle, 79 , $trustedcertindex);
  }
 /**
  * Allows to get or set a 'handle', a unique identifier of the underlying property object.
  *
  ...
  */
  public function setTrustedCertHandle($trustedcertindex, $value) {
    $ret = secureblackbox_authenticodesigner_set($this->handle, 79, $value , $trustedcertindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_authenticodesigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  *
  * @access   public
  * @param    array   Array of event parameters: specifiedchecksum, actualchecksum, signed, cancel    
  */
