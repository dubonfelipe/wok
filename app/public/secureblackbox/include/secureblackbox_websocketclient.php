...
class SecureBlackbox_WebSocketClient {
  ...
  public function __construct() {
    ...
    secureblackbox_websocketclient_register_callback($this->handle, 6, array($this, 'fireTextData'));
  }
...
public function VERSION() {
  ...
  */
  public function setExternalCryptoCustomParams($value) {
    $ret = secureblackbox_websocketclient_set($this->handle, 34, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_websocketclient_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getKnownCertBytes($knowncertindex) {
    return secureblackbox_websocketclient_get($this->handle, 44 , $knowncertindex);
  }
  ...
  */
  public function setKnownCertHandle($knowncertindex, $value) {
    $ret = secureblackbox_websocketclient_set($this->handle, 45, $value , $knowncertindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_websocketclient_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getKnownCRLCount() {
    return secureblackbox_websocketclient_get($this->handle, 46 );
  }
 /**
  * The number of records in the KnownCRL arrays.
  *
  ...
  */
  public function setKnownCRLCount($value) {
    $ret = secureblackbox_websocketclient_set($this->handle, 46, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_websocketclient_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getKnownCRLBytes($knowncrlindex) {
    return secureblackbox_websocketclient_get($this->handle, 47 , $knowncrlindex);
  }
  ...
  */
  public function setKnownCRLHandle($knowncrlindex, $value) {
    $ret = secureblackbox_websocketclient_set($this->handle, 48, $value , $knowncrlindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_websocketclient_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getKnownOCSPCount() {
    return secureblackbox_websocketclient_get($this->handle, 49 );
  }
 /**
  * The number of records in the KnownOCSP arrays.
  *
  ...
  */
  public function setKnownOCSPCount($value) {
    $ret = secureblackbox_websocketclient_set($this->handle, 49, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_websocketclient_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getKnownOCSPBytes($knownocspindex) {
    return secureblackbox_websocketclient_get($this->handle, 50 , $knownocspindex);
  }
  ...
  */
  public function setKnownOCSPHandle($knownocspindex, $value) {
    $ret = secureblackbox_websocketclient_set($this->handle, 51, $value , $knownocspindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_websocketclient_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getProxyAddress() {
    return secureblackbox_websocketclient_get($this->handle, 52 );
  }
 /**
  * The IP address of the proxy server.
  *
  ...
  */
  public function setProxyAddress($value) {
    $ret = secureblackbox_websocketclient_set($this->handle, 52, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_websocketclient_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getServerCertBytes($servercertindex) {
    return secureblackbox_websocketclient_get($this->handle, 90 , $servercertindex);
  }
  ...
  */
  public function getSocketDNSMode() {
    return secureblackbox_websocketclient_get($this->handle, 109 );
  }
 /**
  * Selects the DNS resolver to use: the class's (secure) built-in one, or the one provided by the system.
  *
  ...
  */
  public function setSocketDNSMode($value) {
    $ret = secureblackbox_websocketclient_set($this->handle, 109, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_websocketclient_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getTrustedCertBytes($trustedcertindex) {
    return secureblackbox_websocketclient_get($this->handle, 136 , $trustedcertindex);
  }
  ...
  */
  public function setTrustedCertHandle($trustedcertindex, $value) {
    $ret = secureblackbox_websocketclient_set($this->handle, 137, $value , $trustedcertindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_websocketclient_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getUseDigestAuth() {
    return secureblackbox_websocketclient_get($this->handle, 138 );
  }
 /**
  * Enables or disables the HTTP Digest authentication.
  *
  ...
  */
  public function setUseDigestAuth($value) {
    $ret = secureblackbox_websocketclient_set($this->handle, 138, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_websocketclient_get_last_error($this->handle));
    }
    return $ret;
