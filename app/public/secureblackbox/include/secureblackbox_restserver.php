...
class SecureBlackbox_RESTServer {
  ...
  public function __construct() {
    ...
    secureblackbox_restserver_register_callback($this->handle, 14, array($this, 'fireOptionsRequest'));
    secureblackbox_restserver_register_callback($this->handle, 15, array($this, 'firePatchRequest'));
    secureblackbox_restserver_register_callback($this->handle, 16, array($this, 'firePostRequest'));
    secureblackbox_restserver_register_callback($this->handle, 17, array($this, 'firePutRequest'));
    secureblackbox_restserver_register_callback($this->handle, 18, array($this, 'fireTLSEstablished'));
    secureblackbox_restserver_register_callback($this->handle, 19, array($this, 'fireTLSPSK'));
    secureblackbox_restserver_register_callback($this->handle, 20, array($this, 'fireTLSShutdown'));
    secureblackbox_restserver_register_callback($this->handle, 21, array($this, 'fireTraceRequest'));
  }
  ...
  */
  public function doSetResponseString($connectionid, $data, $contenttype) {
    $ret = secureblackbox_restserver_do_setresponsestring($this->handle, $connectionid, $data, $contenttype);
		$err = $ret;
