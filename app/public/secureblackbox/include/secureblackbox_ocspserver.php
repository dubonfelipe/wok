...
class SecureBlackbox_OCSPServer {
  ...
  public function __construct() {
    ...
    secureblackbox_ocspserver_register_callback($this->handle, 8, array($this, 'fireStatusRequest'));
    secureblackbox_ocspserver_register_callback($this->handle, 9, array($this, 'fireTLSEstablished'));
    secureblackbox_ocspserver_register_callback($this->handle, 10, array($this, 'fireTLSPSK'));
    secureblackbox_ocspserver_register_callback($this->handle, 11, array($this, 'fireTLSShutdown'));
  }
