...
class SecureBlackbox_WebDAVServer {
  ...
  public function __construct() {
    ...
    secureblackbox_webdavserver_register_callback($this->handle, 11, array($this, 'fireQueryQuota'));
    secureblackbox_webdavserver_register_callback($this->handle, 12, array($this, 'fireTLSEstablished'));
    secureblackbox_webdavserver_register_callback($this->handle, 13, array($this, 'fireTLSPSK'));
    secureblackbox_webdavserver_register_callback($this->handle, 14, array($this, 'fireTLSShutdown'));
  }
