...
class SecureBlackbox_SOAPVerifier {
  ...
  public function __construct() {
    ...
    secureblackbox_soapverifier_register_callback($this->handle, 3, array($this, 'fireReferenceValidated'));
    secureblackbox_soapverifier_register_callback($this->handle, 4, array($this, 'fireResolveReference'));
    secureblackbox_soapverifier_register_callback($this->handle, 5, array($this, 'fireRetrieveCertificate'));
    secureblackbox_soapverifier_register_callback($this->handle, 6, array($this, 'fireRetrieveCRL'));
    secureblackbox_soapverifier_register_callback($this->handle, 7, array($this, 'fireRetrieveOCSPResponse'));
    secureblackbox_soapverifier_register_callback($this->handle, 8, array($this, 'fireSignatureFound'));
    secureblackbox_soapverifier_register_callback($this->handle, 9, array($this, 'fireSignatureValidated'));
    secureblackbox_soapverifier_register_callback($this->handle, 10, array($this, 'fireStoreCertificate'));
    secureblackbox_soapverifier_register_callback($this->handle, 11, array($this, 'fireStoreCRL'));
    secureblackbox_soapverifier_register_callback($this->handle, 12, array($this, 'fireStoreOCSPResponse'));
    secureblackbox_soapverifier_register_callback($this->handle, 13, array($this, 'fireTimestampFound'));
    secureblackbox_soapverifier_register_callback($this->handle, 14, array($this, 'fireTimestampValidated'));
  }
...
public function VERSION() {
  ...
  */
  public function getKnownCertBytes($knowncertindex) {
    return secureblackbox_soapverifier_get($this->handle, 50 , $knowncertindex);
  }
  ...
  */
  public function setKnownCertHandle($knowncertindex, $value) {
    $ret = secureblackbox_soapverifier_set($this->handle, 51, $value , $knowncertindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getKnownCRLCount() {
    return secureblackbox_soapverifier_get($this->handle, 52 );
  }
 /**
  * The number of records in the KnownCRL arrays.
  *
  ...
  */
  public function setKnownCRLCount($value) {
    $ret = secureblackbox_soapverifier_set($this->handle, 52, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getKnownCRLBytes($knowncrlindex) {
    return secureblackbox_soapverifier_get($this->handle, 53 , $knowncrlindex);
  }
  ...
  */
  public function setKnownCRLHandle($knowncrlindex, $value) {
    $ret = secureblackbox_soapverifier_set($this->handle, 54, $value , $knowncrlindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getKnownOCSPCount() {
    return secureblackbox_soapverifier_get($this->handle, 55 );
  }
 /**
  * The number of records in the KnownOCSP arrays.
  *
  ...
  */
  public function setKnownOCSPCount($value) {
    $ret = secureblackbox_soapverifier_set($this->handle, 55, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getKnownOCSPBytes($knownocspindex) {
    return secureblackbox_soapverifier_get($this->handle, 56 , $knownocspindex);
  }
  ...
  */
  public function setKnownOCSPHandle($knownocspindex, $value) {
    $ret = secureblackbox_soapverifier_set($this->handle, 57, $value , $knownocspindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getLastArchivalTime() {
    return secureblackbox_soapverifier_get($this->handle, 58 );
  }
  ...
  */
  public function getOCSPBytes($ocspindex) {
    return secureblackbox_soapverifier_get($this->handle, 60 , $ocspindex);
  }
  ...
  */
  public function getOfflineMode() {
    return secureblackbox_soapverifier_get($this->handle, 66 );
  }
 /**
  * Switches the class to the offline mode.
  *
  ...
  */
  public function setOfflineMode($value) {
    $ret = secureblackbox_soapverifier_set($this->handle, 66, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function setProxyAddress($value) {
    $ret = secureblackbox_soapverifier_set($this->handle, 68, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getReferenceAutoGenerateElementId($referenceindex) {
    return secureblackbox_soapverifier_get($this->handle, 81 , $referenceindex);
  }
  ...
  */
  public function getReferenceCanonicalizationMethod($referenceindex) {
    return secureblackbox_soapverifier_get($this->handle, 82 , $referenceindex);
  }
  ...
  */
  public function getReferenceCustomElementId($referenceindex) {
    return secureblackbox_soapverifier_get($this->handle, 83 , $referenceindex);
  }
  ...
  */
  public function getRevocationCheck() {
    return secureblackbox_soapverifier_get($this->handle, 99 );
  }
 /**
  * Specifies the kind(s) of revocation check to perform.
  *
  ...
  */
  public function setRevocationCheck($value) {
    $ret = secureblackbox_soapverifier_set($this->handle, 99, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getSignatureIndex() {
    return secureblackbox_soapverifier_get($this->handle, 100 );
  }
 /**
  * The index of the signature to update.
  *
  ...
  */
  public function setSignatureIndex($value) {
    $ret = secureblackbox_soapverifier_set($this->handle, 100, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getSignatureType() {
    return secureblackbox_soapverifier_get($this->handle, 101 );
  }
  ...
  */
  public function getSignatureValidationResult() {
    return secureblackbox_soapverifier_get($this->handle, 102 );
  }
  ...
  */
  public function getSigningCertBytes() {
    return secureblackbox_soapverifier_get($this->handle, 103 );
  }
  ...
  */
  public function getSigningCertCA() {
    return secureblackbox_soapverifier_get($this->handle, 104 );
  }
  ...
  */
  public function getSigningCertCAKeyID() {
    return secureblackbox_soapverifier_get($this->handle, 105 );
  }
  ...
  */
  public function setSocketDNSMode($value) {
    $ret = secureblackbox_soapverifier_set($this->handle, 130, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function setSocketDNSPort($value) {
    $ret = secureblackbox_soapverifier_set($this->handle, 131, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function setSocketDNSQueryTimeout($value) {
    $ret = secureblackbox_soapverifier_set($this->handle, 132, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function setSocketDNSServers($value) {
    $ret = secureblackbox_soapverifier_set($this->handle, 133, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function setSocketDNSTotalTimeout($value) {
    $ret = secureblackbox_soapverifier_set($this->handle, 134, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function setSocketIncomingSpeedLimit($value) {
    $ret = secureblackbox_soapverifier_set($this->handle, 135, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function setSocketLocalAddress($value) {
    $ret = secureblackbox_soapverifier_set($this->handle, 136, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function setTLSAutoValidateCertificates($value) {
    $ret = secureblackbox_soapverifier_set($this->handle, 153, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function setTLSBaseConfiguration($value) {
    $ret = secureblackbox_soapverifier_set($this->handle, 154, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function setTLSCiphersuites($value) {
    $ret = secureblackbox_soapverifier_set($this->handle, 155, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function setTLSECCurves($value) {
    $ret = secureblackbox_soapverifier_set($this->handle, 156, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function setTLSForceResumeIfDestinationChanges($value) {
    $ret = secureblackbox_soapverifier_set($this->handle, 157, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function setTLSPreSharedIdentity($value) {
    $ret = secureblackbox_soapverifier_set($this->handle, 158, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function setTLSPreSharedKey($value) {
    $ret = secureblackbox_soapverifier_set($this->handle, 159, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getTLSRenegotiationAttackPreventionMode() {
    return secureblackbox_soapverifier_get($this->handle, 161 );
  }
 /**
  * Selects renegotiation attack prevention mechanism.
  *
  ...
  */
  public function setTLSRenegotiationAttackPreventionMode($value) {
    $ret = secureblackbox_soapverifier_set($this->handle, 161, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getTLSRevocationCheck() {
    return secureblackbox_soapverifier_get($this->handle, 162 );
  }
 /**
  * Specifies the kind(s) of revocation check to perform.
  *
  ...
  */
  public function setTLSRevocationCheck($value) {
    $ret = secureblackbox_soapverifier_set($this->handle, 162, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function setTLSSSLOptions($value) {
    $ret = secureblackbox_soapverifier_set($this->handle, 163, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getTLSTLSMode() {
    return secureblackbox_soapverifier_get($this->handle, 164 );
  }
 /**
  * Specifies the TLS mode to use.
  *
  ...
  */
  public function setTLSTLSMode($value) {
    $ret = secureblackbox_soapverifier_set($this->handle, 164, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getTLSUseExtendedMasterSecret() {
    return secureblackbox_soapverifier_get($this->handle, 165 );
  }
 /**
  * Enables Extended Master Secret Extension, as defined in RFC 7627.
  *
  ...
  */
  public function setTLSUseExtendedMasterSecret($value) {
    $ret = secureblackbox_soapverifier_set($this->handle, 165, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getTrustedCertBytes($trustedcertindex) {
    return secureblackbox_soapverifier_get($this->handle, 169 , $trustedcertindex);
  }
  ...
  */
  public function getTrustedCertHandle($trustedcertindex) {
    return secureblackbox_soapverifier_get($this->handle, 170 , $trustedcertindex);
  }
 /**
  * Allows to get or set a 'handle', a unique identifier of the underlying property object.
  *
  ...
  */
  public function setTrustedCertHandle($trustedcertindex, $value) {
    $ret = secureblackbox_soapverifier_set($this->handle, 170, $value , $trustedcertindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getTSACertKeyAlgorithm() {
    return secureblackbox_soapverifier_get($this->handle, 182 );
  }
  ...
  */
  public function getTSACertKeyBits() {
    return secureblackbox_soapverifier_get($this->handle, 183 );
  }
  ...
  */
  public function setValidationMoment($value) {
    $ret = secureblackbox_soapverifier_set($this->handle, 200, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function setXAdESVersion($value) {
    $ret = secureblackbox_soapverifier_set($this->handle, 203, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function setNamespaceCount($value) {
    $ret = secureblackbox_soapverifier_set($this->handle, 204, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getNamespacePrefix($namespaceindex) {
    return secureblackbox_soapverifier_get($this->handle, 205 , $namespaceindex);
  }
 /**
  * A user-defined prefix value of a namespace.
  *
  ...
  */
  public function setNamespacePrefix($namespaceindex, $value) {
    $ret = secureblackbox_soapverifier_set($this->handle, 205, $value , $namespaceindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getNamespaceURI($namespaceindex) {
    return secureblackbox_soapverifier_get($this->handle, 206 , $namespaceindex);
  }
 /**
  * A user-defined URI value of a namespace.
  *
  ...
  */
  public function setNamespaceURI($namespaceindex, $value) {
    $ret = secureblackbox_soapverifier_set($this->handle, 206, $value , $namespaceindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapverifier_get_last_error($this->handle));
    }
    return $ret;
