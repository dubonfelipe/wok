...
class SecureBlackbox_TLSServer {
  ...
  public function __construct() {
    ...
    secureblackbox_tlsserver_register_callback($this->handle, 8, array($this, 'fireTLSEstablished'));
    secureblackbox_tlsserver_register_callback($this->handle, 9, array($this, 'fireTLSPSK'));
    secureblackbox_tlsserver_register_callback($this->handle, 10, array($this, 'fireTLSShutdown'));
  }
